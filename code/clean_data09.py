...
df = pd.read_stata('../data/2009/personsx.dta')
...
df['bio_mother'] = df['mom_deg'].isin(['1 Biological','2 Adoptive'])
df['bio_father'] = df['dad_deg'].isin(['1 Biological','2 Adoptive'])
...
df['private1_thru_wrk_other'] = df['plnwrkn1'].isin(["03 Through workplace, but don't know if employer or union",
...
df['private2_thru_wrk_other'] = df['plnwrkn2'].isin(["03 Through workplace, but don't know if employer or union",
                                                     '04 Through workplace, self-employed or professional association'])
...
df['year'] = 2009
df.to_csv('../data/clean/data2009.csv')
